...
export const getBomByFinishedGood = (finishedGoodId) =>
  api.get(`/bom/finished-goods/${finishedGoodId}`);
...
export const addBomItem = (bomId, data) =>
  api.post(`/bom/${bomId}/items`, data);
export const updateBomItem = (bomId, itemId, data) =>
  api.put(`/bom/${bomId}/items/${itemId}`, data);
export const deleteBomItem = (bomId, itemId) =>
  api.delete(`/bom/${bomId}/items/${itemId}`);
